...
export default function Footer() {
  return (
    <div className="container mt-5  p-5 border-top " style={{ backgroundColor:"#fbfbfb" }}>
      <div className="row ">
        <div className="col">
          <h1>Zerodha</h1>
          <p>
      ...
      <p className="text-muted" style={ {marginTop:"50px", fontSize:"12px"}}>
        ...
        Risk Disclosure Document as prescribed by SEBI | ICF <br/> Procedure to file a
        ...
        grievances<br/> Smart Online Dispute Resolution | Grievances Redressal
        Mechanism <br/> Investments in securities market are subject to market risks;
        read all the related documents carefully before investing. <br/> Attention
        ...
        NSDL/CDSL every month. <br/>"Prevent unauthorised transactions in your
        ...
        claiming to be part of Zerodha and offering such services, please create
        a ticket here.
      </p>
